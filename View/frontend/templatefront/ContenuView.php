...
<head>
  ...
  <title>Skill swap contenu</title>
</head>
      ...
      <div class="container position-relative">
        <div class="site-navigation text-center">
          ...
          <ul class="js-clone-nav d-none d-lg-inline-block site-menu">
            ...
            <li><a href="ContenuView.php">Forum</a></li>
        ...
        <div class="col-12">
          <div class="row justify-content-center ">
            <div class="col-lg-6 text-center ">
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Skill Swap</h1>
              <div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
                <p><a href="https://untree.co/" target="_blank" class="link-highlight"></a>Welcome to the Skill Swap platform where you can exchange skills with others. Whether you want to learn a new language, improve your coding skills, or share your expertise in photography, this is the place for you!</p>
              </div>
        ...
        <div class="row">
            ...
            <?php foreach ($contenu as $item): ?>
                <div class="content-item">
                    <h3><?php echo htmlspecialchars($item['nomContenu']); ?></h3><br>
                    <p><?php echo htmlspecialchars($item['descriptionContenu']); ?></p><br>
                </div>
                <br>
            <?php endforeach; ?>
        <?php else: ?>
