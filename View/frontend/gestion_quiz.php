      ...
      <div class="container position-relative">
        <div class="site-navigation text-center">
          ...
          <ul class="js-clone-nav d-none d-lg-inline-block site-menu">
            ...
            <li class="active"><a href="gestion_quiz.html">Quiz</a></li>
        ...
        <div class="col-12">
          <div class="row justify-content-center ">
            <div class="col-lg-6 text-center ">
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">QUIZ</h1>
              <div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
               
              </div>

              <p class="mb-0" data-aos="fade-up" data-aos-delay="300"><a href="#quiz" class="btn btn-secondary">Explore quiz</a></p>
