        ...
        <div class="col-12">
          <div class="row justify-content-center ">
            <div class="col-lg-6 text-center ">
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Continue</h1>
              <div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
               
              </div>

              <p class="mb-0" data-aos="fade-up" data-aos-delay="300"><a href="#Rquiz" class="btn btn-secondary">Explore courses</a></p>
...
?>
    ...
    <script>
        let timeLeft = 30* <?php echo $numberOfQuestions?> ; // Temps en secondes (5 minutes)
    ...
    <div id="timer">Temps restant : <?php echo $numberOfQuestions/2;?>:00</div>
