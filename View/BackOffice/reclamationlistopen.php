...
$reclamations = $reclamationController->getReclamationsByStatus('Open');
?>
...
<body>
    ...
    <table>
        ...
        <?php else : ?>
            <tr>
                <td colspan="5">No open reclamations found.</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
