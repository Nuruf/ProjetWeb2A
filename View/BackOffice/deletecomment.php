<?php
include '../config.php';
include '../controller/commentController.php';  // Include CommentController
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($comment) {
        ...
        if ($deleteSuccess) {
            ...
            header("Location: dashboard backoffice.php");  // Redirect back to the create page (or wherever you want)
            exit;
        } else {
